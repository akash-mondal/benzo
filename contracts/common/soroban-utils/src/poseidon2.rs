...
mod host_differential_tests {
    //! Direct host-vs-guest Poseidon2 differential (the pre-ceremony GATE from
    //! docs/ZK-AUDIT-AND-STANDARDS.md A.3 / C Step 2).
    //!
    ...
    fn host_hash2_t3_matches_ts_mirror() {
        ...
        assert_eq!(
            h(1, 2, Some(1)),
            expect(&env, &[
                44, 80, 198, 230, 66, 213, 199, 200, 179, 89, 71, 165, 240, 14, 19, 145, 220, 68,
                59, 23, 183, 187, 109, 197, 214, 188, 25, 53, 11, 109, 252, 180,
            ])
        );
        ...
        assert_eq!(
            h(3, 4, Some(2)),
            expect(&env, &[
                47, 167, 245, 102, 20, 163, 200, 72, 203, 247, 45, 112, 74, 211, 142, 234, 177, 2,
                139, 14, 119, 219, 125, 116, 137, 44, 138, 90, 114, 202, 108, 180,
            ])
        );
        ...
        assert_eq!(
            h(5, 6, None),
            expect(&env, &[
                8, 87, 223, 114, 214, 237, 119, 82, 203, 146, 139, 68, 162, 236, 68, 26, 32, 228,
                25, 39, 92, 115, 98, 214, 17, 109, 58, 250, 198, 62, 187, 9,
            ])
        );
    }
    ...
    fn host_compress_t2_matches_ts_mirror() {
        ...
        assert_eq!(
            ...
            expect(&env, &[
                3, 18, 251, 99, 126, 92, 89, 27, 68, 166, 185, 99, 94, 203, 126, 16, 76, 123, 137,
                191, 42, 146, 224, 76, 99, 182, 220, 180, 121, 189, 130, 251,
            ])
        );
    }
}
